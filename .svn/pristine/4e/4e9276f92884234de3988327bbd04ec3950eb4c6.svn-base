...
<!--  -->
		<!-- 		<div class="queryCondition">
					<div class="dateRemind" style="display:inline;float: left">
					<span class="remind">date：</span>
				</div>
				<div class="date">
					<div class="dateView" id="s1" hidden="true">
						<input class="begin form-control" name="begin" readonly="readonly"
							style="float: left" />
						<div
							style="position: relative; width: 36px;  float: left; text-align: center">
							to</div>
          ...
          operateDelete: function () {
              $('#btn_delete').on("click", function () {
            	...
            	/*   var arrselectedData =  $('#cusTable').bootstrapTable("getAllSelections");
      	    	...
      	    	toastr.info('Are you sure you want to delete?<br /><br /><button onclick="deleteByArray()" type="button" class="btn clear">Yes</button>');
 */
              });
          },
        //导入
    ...
    //初始化fileinput
      ...
      $(function() {
    	  ...
    	  $("#leftfansDaily").css("background","#578EBE");
      	getTitle(tableTitleName,role);
    	//初始化表格
      	//日期初始化
      	initDate();
