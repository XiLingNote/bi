...
public class DrillShowBean implements java.io.Serializable {
	...
	public DrillShowBean(String date, String showAmount, String clickQuantity, String cost, String clicktRate,
		...
		this.cost = UtilTool.convertToStringZero(cost);
		this.clicktRate = UtilTool.convertToDecimal(clicktRate);
		this.clickUnit = UtilTool.convertToStringZero(clickUnit);
		this.costPresentingThousand = UtilTool.convertToStringZero(costPresentingThousand);
		...
		this.orderTransactionAmount = UtilTool.convertToStringZero(orderTransactionAmount);
