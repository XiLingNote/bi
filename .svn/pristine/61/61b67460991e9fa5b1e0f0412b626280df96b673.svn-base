...
(function ($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		init_controls: function()
		{
			...
			// Controls
			this.$btn_left = this.$container.append('<a href="javascript:void(0)" class="vmc-arrow-left"></a>').find('.vmc-arrow-left');
			this.$btn_right = this.$container.append('<a href="javascript:void(0)" class="vmc-arrow-right"></a>').find('.vmc-arrow-right');
