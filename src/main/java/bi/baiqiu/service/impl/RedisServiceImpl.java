...
public class RedisServiceImpl {
	...
	*/
	public RedisPojo getBusinessMonth(String business) throws Exception{
		Jedis jedis = pool.getResource();
		...
		jedis.close();
		return redisBusinessMonth;
	}
	/** 
	 * @Function: getBusinessToday 
	 * @Description:获取事业部今天的数据
	 * @param business
	 * @return    
	 * @return RedisPojo 
	 * @throws 
	 ...
	 * 2017年9月27日      Jared           v1.0.0              
	*/
	public RedisPojo getBusinessToday(String business) throws Exception{
		Jedis jedis = pool.getResource();
		Calendar canlendar = Calendar.getInstance();
		canlendar.setTime(DateUtils.getTestNow());
		...
		jedis.close();
		return redisBusinessToday;
	}
	/** 
	 * @Function: getBusinessYesterday 
	 * @Description:获取事业部昨日的数据
	 * @param business
	 * @return    
	 * @return RedisPojo 
	 * @throws 
	 ...
	 * 2017年9月27日      Jared           v1.0.0              
	*/
	public  RedisPojo getBusinessYesterday(String business) throws Exception{
		Jedis jedis = pool.getResource();
		Calendar canlendar = Calendar.getInstance();
		canlendar.setTime(DateUtils.getTestNow());
		//昨日
		canlendar.set(Calendar.DAY_OF_MONTH,canlendar.get(Calendar.DAY_OF_MONTH)-1);
