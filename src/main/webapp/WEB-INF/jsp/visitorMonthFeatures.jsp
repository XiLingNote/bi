...
<script>
      /*   $(document).ready(function(){
        ...
        var tableTitleName="visitorMonthFeatures";
        ...
        function initTable(tableTitle) {
            ...
            $("#cusTable").bootstrapTable({
                ...
                url: "<%=basePath%>visitorMonthFeature/queryVisitorMonthFeatureByPage.do", //获取数据的Servlet地址
                striped: true,  //表格显示条纹
    ...
    //初始化fileinput
      ...
      $(function() {
    	//初始化左侧菜单栏
    	  ...
    	  $("#leftvisitorMonthFeatures").css("background","#578EBE");
    	getTitle(tableTitleName,role);
    	//初始化表格
      	//日期初始化
      	initDate();
      	...
      	operate.operateInit();
      	//初始化上传文件
           inportInit("txt_file", "<%=basePath%>visitorMonthFeature/uploadVisitorMonthFeatures.do");
  	//	pandora潘多拉官方旗舰店
      ...
      function deleteByArray(){
    	...
    	var a=  {"idArray":idArray};
          $.ajax({
              url: "<%=basePath%>visitorMonthFeature/deleteVisitorMonthFeaturesByBatch.do",
              type: "post",
              data:a,
              success: function (data, status) {
            	  showTip(JSON.parse(data).data);
