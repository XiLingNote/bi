...
/* 提示框 */
        ...
        function initTable(tableTitle) {
            ...
            $("#cusTable").bootstrapTable({
                ...
                url: "<%=basePath%>pcFlowStructure/queryPcFlowStructureByPage.do", //获取数据的Servlet地址
                striped: true,  //表格显示条纹
                ...
                onEditableSave: function (field, row, oldValue, $el) {
                    $.ajax({
                        type: "post",
                        url: "<%=basePath%>pcFlowStructure/updatePcFlowStructure.do",
                        data: row,
                        dataType: 'JSON',
    ...
    //初始化fileinput
      ...
      function deleteByDate(){
    	  ...
    	  $.ajax({
              url: 
            	  "<%=basePath%>pcFlowStructure/deletePcFlowStructure.do",
					type : "post",
					data : a,
					success : function(data, status) {
      ...
      function deleteByArray(){
    	...
    	var a=  {"idArray":idArray};
          $.ajax({
              url: 
            	  "<%=basePath%>pcFlowStructure/deletePcFlowStructureByBatch.do",
					type : "post",
					data : a,
					success : function(data, status) {
						toastr.success(JSON.parse(data).data)
