...
<body>
<form action="/salesAnalysis/astronymy/calendar/get.do">
源日期：<input type="date">
<select>
<option>阴历转阳历</option>
<option>阳历转阴历</option>
...
<canvas id="c_16" width="1292" height="871" style="position: fixed; top: 0px; left: 0px; z-index: -2; opacity: 0.5;">
</canvas>
</body>
</html>