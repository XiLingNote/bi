/**
 * fullPage 2.5.4 https://github.com/alvarotrigo/fullPage.js MIT licensed
 * 
...
(function(b) {
    b.fn.fullpage = function(c) {
        ...
        function ka(a) {
            a.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + la(a)*0.9 + 'px;" />')
        }
        function la(a) {
            var b = h;
        ...
        b(".fp-section").each(function(a) {
            ...
            b(this).css("height", h*0.9 + "px"); (c.paddingTop || c.paddingBottom) && b(this).css("padding", c.paddingTop + " 0 " + c.paddingBottom + " 0");
