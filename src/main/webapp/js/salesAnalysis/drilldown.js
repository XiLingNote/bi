...
(function(p) {
    "object" === typeof module && module.exports ? module.exports = p: p(Highcharts)
        ...
        m.prototype.addSingleSeriesAsDrilldown = function(a, b) {
            ...
            u = d.options._levelNumber || 0; (n = this.drilldownLevels[this.drilldownLevels.length - 1]) && n.levelNumber !== u && (n = void 0);
            b = q(q({
                _ddSeriesId: F++
            },
            m), b);
            ...
            l(d.chart.series,
            function(a) {
                a.xAxis !== c || a.isDrilling || (a.options._ddSeriesId = a.options._ddSeriesId || F++, a.options._colorIndex = a.userOptions._colorIndex, a.options._levelNumber = a.options._levelNumber || u, n ? (k = n.levelSeries, h = n.levelSeriesOptions) : (k.push(a), h.push(a.options)))
            });
            a = q({
                levelNumber: u,
                ...
                color: a.isNull ? (new f.Color(z)).setOpacity(0).get() : z,
            ...
            d.type === b.type && (b.animate = b.animateDrilldown || p, b.options.animation = !0)
        };
        m.prototype.applyDrilldown = function() {
            var a = this.drilldownLevels,
            b;
            a && 0 < a.length && (b = a[a.length - 1].levelNumber, l(this.drilldownLevels,
            function(a) {
                a.levelNumber === b && l(a.levelSeries,
                function(a) {
        ...
        m.prototype.getDrilldownBackText = function() {
            var a = this.drilldownLevels;
            if (a && 0 < a.length) return a = a[a.length - 1],
            a.series = a.seriesOptions,
            G(this.options.lang.drillUpText, a)
        };
        m.prototype.showDrillUpButton = function() {
            ...
            this.drillUpButton ? this.drillUpButton.attr({
                text: b
            }).align() : (e = (c = d.theme) && c.states, this.drillUpButton = this.renderer.button(b, null, null,
            function() {
                a.drillUp()
            },
        ...
        m.prototype.drillUp = function() {
            for (var a = this,
            b = a.drilldownLevels,
            d = b[b.length - 1].levelNumber, c = b.length, e = a.series, g, k, h, f, n = function(b) {
                var c;
                l(e,
                function(a) {
                ...
                b === k.seriesOptions && (f = c)
            }; c--;) if (k = b[c], k.levelNumber === d) {
                b.pop();
                h = k.lowerSeries;
                if (!h.chart) for (g = e.length; g--;) if (e[g].options.id === k.lowerSeriesOptions.id && e[g].options._levelNumber === d + 1) {
                    h = e[g];
                    break
                }
                h.xData = [];
                l(k.levelSeriesOptions, n);
                x(a, "drillup", {
                    seriesOptions: k.seriesOptions
                });
                f.type === h.type && (f.drilldownLevel = k, f.options.animation = a.options.drilldown.animation, h.animateDrillupFrom && h.chart && h.animateDrillupFrom(k));
                f.options._levelNumber = d;
                h.remove(!1);
                f.xAxis && (g = k.oldExtremes, f.xAxis.setExtremes(g.xMin, g.xMax, !1), f.yAxis.setExtremes(g.yMin, g.yMax, !1));
        ...
        t.prototype.animateDrilldown = function(a) {
            ...
            }), c.x += v(g.oldPos, g.pos) - g.pos, l(this.points,
            function(a) {
                a.shapeArgs.fill = a.color;
                a.graphic && a.graphic.attr(c).animate(q(a.shapeArgs, {
        ...
        t.prototype.animateDrillupFrom = function(a) {
            ...
            function(e) {
                ...
                g && (delete e.graphic, h.fill = a.color, b ? g.animate(h, f.merge(b, {
                    complete: l
                })) : (g.attr(h), l()))
            })
        };
        ...
        D.prototype.drillable = function() {
            ...
            e = c && d.getDDPoints(a);
            c && (b && e.length ? (b.drillable = !0, b.basicStyles || (b.basicStyles = f.merge(b.styles)), b.addClass("highcharts-drilldown-axis-label").css(d.chart.options.drilldown.activeAxisLabelStyle).on("click",
            function(b) {
                d.drilldownCategory(a, b)
            })) : b && b.drillable && (b.styles = {},
            b.css(b.basicStyles), b.on("click", null), b.removeClass("highcharts-drilldown-axis-label")))
        };
        r(D.prototype, "addLabel",
        function(a) {
            a.call(this);
            this.drillable()
        });
        r(f.Point.prototype, "init",
        function(a, b, d, c) {
            var e = a.call(this, b, d, c);
            c = (a = b.xAxis) && a.ticks[c];
            e.drilldown && f.addEvent(e, "click",
            function(a) {
        ...
        r(f.Series.prototype, "drawDataLabels",
        function(a) {
        ...
        B(w,
        function(a) {
            r(a.prototype, "drawTracker", H);
            r(a.prototype.pointClass.prototype, "setState", I)
        })
    })(p)
});